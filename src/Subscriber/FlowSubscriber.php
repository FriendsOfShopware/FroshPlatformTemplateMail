...
class FlowSubscriber implements EventSubscriberInterface
{
    ...
    public static function getSubscribedEvents()
    {
        ...
        return [
            FlowSendMailActionEvent::class => 'sendMail'
        ];
    }

    public function sendMail(FlowSendMailActionEvent $bagFilter)
    {
        /** @var MailTemplateTypeEntity $mailTemplateType */
        $mailTemplateType = $this->mailTemplateTypeRepository->search(new Criteria([$bagFilter->getMailTemplate()->getMailTemplateTypeId()]), Context::createDefaultContext()) ->first();
